...
function [] = utdNodesCalONN_01(nodeIndex)
...
versionStrPre = 'UTD_Ronn_All_ONN_1';
...
disp(graphTitle1)
display(newline)
globalCSVLabel = "resultsNowXT_ONN_1"
...
for targetIndex = 1: length(mintsTargets)
    try
        ...
        [In_Train,Out_Train,...
            ...
            = representativeSampleSimpleTT(...
                utdWithTargets,mintsInputs,target,pValid);
