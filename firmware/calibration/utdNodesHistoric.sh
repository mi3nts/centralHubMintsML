...
#SBATCH -o logs/historic/utdNodesHistoric.%j.out # Name of stdout output file (%j expands to jobId)
#SBATCH -e err/historic/utdNodesHistoric.%j.err # Error File Name 
...
matlab -nodesktop -nodisplay -nosplash -r "liveRunHistoricEuropa("$SLURM_ARRAY_TASK_ID"); quit"
