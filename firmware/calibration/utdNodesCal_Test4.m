function [] = utdNodesCal_Test4(nodeIndex)
    ...
    % Added TEST4 for Label String and Label String Daily  
    % Meant for Super Learner 
    
    clc
    clearvars -except nodeIndex 
    close all 

    versionStrPre = 'UTD_Rel_All_TEST4';
    ...
    disp(graphTitle1)
    display(newline)           
    globalCSVLabel = "resultsNowXT2_TEST4"
