...
#SBATCH -J utdNodesTest0      # Job name
#SBATCH -o logs/utdNodesTest0.%j.out # Name of stdout output file (%j expands to jobId)
#SBATCH -e logs/utdNodesTest0.%j.err # Error File Name 
