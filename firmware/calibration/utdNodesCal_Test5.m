...
function [] = utdNodesCal_Test5(nodeIndex)
    ...
    % Added TEST5 for Label String and Label String Daily  
    % Meant for Ensemble Learner   
    
    clc
    clearvars -except nodeIndex 
    close all 

    versionStrPre = 'UTD_Rsl_All_TEST5';
    ...
    disp(graphTitle1)
    display(newline)           
    globalCSVLabel = "resultsNowXT2_TEST5"
