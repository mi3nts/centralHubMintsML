...
plot(utdWithTargets.dateTime,utdWithTargets.pm2_5)
hold on 
plot(utdWithTargets.dateTime,utdWithTargets.binCount0)
plot(utdWithTargets.dateTime,utdWithTargets.pm2_5_palas)     
