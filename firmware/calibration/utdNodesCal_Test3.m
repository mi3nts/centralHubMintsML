...
function [] = utdNodesCal_Test3(nodeIndex)
    ...
    % Added TEST3 for Label String and Label String Daily  
    % Meant for Optimized Neural Network 
    
    clc
    clearvars -except nodeIndex 
    close all 
    versionStrPre = 'UTD_Ronn_All_TEST3';
    ...
    disp(graphTitle1)
    display(newline)           
    globalCSVLabel = "resultsNowXT2_TEST3"
