...
%     Top_Title=strcat(estimator," - Node " +string(nodeID)," - " ,stringIn);
    Top_Title=strcat(estimator," ",stringIn);

    %% Start Now 
    Middle_Title = strcat("Training: R = ", string(rTrain),...
                                  ", RMSE = ",string(rmseTrain),...
                                   ", N = ",string(length(dataXTrain)));
    Middle2nd_Title = strcat("Validating: R = ", string(rValid),...
                                  ", RMSE = ",string(rmseValid),...
                                   ", N = ",string(length(dataXValid)));                               
    Bottom_Title=strcat("Combined: R = ", string(rAll),...
                                  ", RMSE = ",string(rmse),...
