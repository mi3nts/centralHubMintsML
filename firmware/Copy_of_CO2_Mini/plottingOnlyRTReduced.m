...
load('RTOutReduced.mat')
outTrainEstimate = outTrainEstimate';
outValidEstimate = outValidEstimate';
...
combinedFig = "co2RT_Reduced.png"

graphTitle1     = "Regression Tree";
graphTitle2 = strcat(" ");
%    
