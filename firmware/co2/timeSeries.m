...
dataX1 = [validatingTT.dateTime];
dataY1 = [validatingTT.CO2];
dataX2 = [validatingTT.dateTime];
dataY2 = [outValidEstimate];
dl1    = instrument;
dl2    = "Enseble Learner Estimate";
% nodeID
xLabel   = "Date Time"
yLabel   = "CO_{2} (ppm)"
titleIn  = "CO_{2} Ensemble Learner"
fileName = "co2Final.png"
