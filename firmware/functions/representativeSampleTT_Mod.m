            ...
            In_Validation,Out_Validation,...
               trainingTT, validatingTT,...
                trainingT, validatingT ] ...
                            = representativeSampleTT_Mod(...
                                timeTableIn,inputVariables,target,pvalid,...
                                nodeID, targetLabel,mergedMatsFolder,...    
                                nbins_per_column,n_per_bin)
...
try
    if(target=="CO2")
        ...
        timeTableIn(timeTableIn.CO2>1000,:) = [];
         timeTableIn(...
         timeTableIn.dateTime<datetime(2020,12,20,'timezone','utc')&...
         timeTableIn.dateTime>datetime(2020,12,19,'timezone','utc'),:)=[];
